...
const RegisterRestaurant = props => {
    ...
    // const handleFireBaseUpload = (callback) => {
    ...
    //             callback(firebase.storage().ref('images').child(imageAsFile.name).getDownloadURL())
    //         })
    // }

    const dynamicFileSeter = (seter) => (file) => seter(file)
        ...
        <div className='register-restaurant'>
            <Form>
                ...
                <Form.Row>
                    ...
                    <Form.Group as={Col} id="formGridFile">
                        <Form.Label>Imagen para perfil del Restaurante</Form.Label>
                        <ImageUploader />
                    </Form.Group>
                </Form.Row>
